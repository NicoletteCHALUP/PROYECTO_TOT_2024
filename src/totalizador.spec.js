...
describe("Calcular Total Descuento", () => {
  ...
  describe("Descuento Categoria", () => {
    ...
    it("deberia mostrar el descuento e impuesto calculado correspondiente a Muebles y mostrarlo en precio total", () => {
      const descuento= Number.parseFloat(DescuentoCategoria("Muebles"));
      const impuesto= Number.parseFloat(ImpuestoCategoria("Muebles"));
      const TotalDescuentoCat= Number.parseFloat(TotalDescuentoCategoria(1000,descuento));
      const TotalImpuestoCat= Number.parseFloat(TotalImpuestoCategoria(1000,impuesto));
      expect(PrecioTotalconCategoria(2000,TotalDescuentoCat,TotalImpuestoCat)).toEqual("2030.00");
    });
    it("deberia mostrar el descuento e impuesto calculado correspondiente a Electrónicos y mostrarlo en precio total", () => {
      const descuento= Number.parseFloat(DescuentoCategoria("Electronicos"));
      const impuesto= Number.parseFloat(ImpuestoCategoria("Electronicos"));
      const TotalDescuentoCat= Number.parseFloat(TotalDescuentoCategoria(1000,descuento));
      const TotalImpuestoCat= Number.parseFloat(TotalImpuestoCategoria(1000,impuesto));
      expect(PrecioTotalconCategoria(2000,TotalDescuentoCat,TotalImpuestoCat)).toEqual("2030.00");
    });
    it("deberia mostrar el descuento e impuesto calculado correspondiente a Vestimenta y mostrarlo en precio total", () => {
      const descuento= Number.parseFloat(DescuentoCategoria("Vestimenta"));
      const impuesto= Number.parseFloat(ImpuestoCategoria("Vestimenta"));
      const TotalDescuentoCat= Number.parseFloat(TotalDescuentoCategoria(1000,descuento));
      const TotalImpuestoCat= Number.parseFloat(TotalImpuestoCategoria(1000,impuesto));
      expect(PrecioTotalconCategoria(2000,TotalDescuentoCat,TotalImpuestoCat)).toEqual("2020.00");
    });
    it("deberia mostrar el descuento e impuesto calculado correspondiente a Varios y mostrarlo en precio total", () => {
      const descuento= Number.parseFloat(DescuentoCategoria("Varios"));
      const impuesto= Number.parseFloat(ImpuestoCategoria("Varios"));
      const TotalDescuentoCat= Number.parseFloat(TotalDescuentoCategoria(1000,descuento));
      const TotalImpuestoCat= Number.parseFloat(TotalImpuestoCategoria(1000,impuesto));
    ...
    it("deberia mostrar el descuento e impuesto calculado correspondiente si no se manda ninguna dato a descuento y mostrarlo en precio total", () => {
      const descuento= Number.parseFloat(DescuentoCategoria(""));
      const impuesto= Number.parseFloat(ImpuestoCategoria("Varios"));
      const TotalDescuentoCat= Number.parseFloat(TotalDescuentoCategoria(1000,descuento));
      const TotalImpuestoCat= Number.parseFloat(TotalImpuestoCategoria(1000,impuesto));
      expect(PrecioTotalconCategoria(2000,TotalDescuentoCat,TotalImpuestoCat)).toEqual("2000.00");
